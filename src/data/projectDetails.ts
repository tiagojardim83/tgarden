  ...
  },
  {
    ...
    pt: {
      ...
      sections: [
        ...
        {
          videoKey: 'Motion_03',
          heading: 'Ritmo visual.',
          text: 'Cada quadro segue uma cadência própria, criando uma assinatura de movimento reconhecível em qualquer peça.',
          client: 'Carnaval dos Sonhos',
          sector: 'Entretenimento & Cultura Popular',
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          text: 'Each frame follows its own cadence, creating a recognizable motion signature across every piece.',
          client: 'Carnaval dos Sonhos',
          sector: 'Entertainment & Popular Culture',
        },
        {
